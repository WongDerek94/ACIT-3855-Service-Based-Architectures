...
function App() {
  ...
  const getCommonImmediateResidentialType = () => {
    axios.get("http://localhost:8110/rental/immediate/common-residence")
    .then(json => {
      console.log(json.data)
  ...
  const getCommonScheduledResidentialType = () => {
    axios.get(`http://localhost:8110/rental/schedule/common-residence?startDate=2020-06-17T17:32:59.283Z&endDate=2020-06-17T17:32:59.283Z`)
    .then(json => {
      console.log(json.data)
